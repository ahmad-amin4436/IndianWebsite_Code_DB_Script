...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <section id="pricing" class="section dark-bg text-light">
        <div class="container">
          ...
          <br />
                        Always-on, 24/7 fully-managed support • Bare metal servers with root access • Flexible server configurations
                    </p>
                </div>
            </div>
            ...
            <style>
                ...
                .gradient-border {
                    ...
                    border-radius: 12px;
                    background: linear-gradient(#0d1117, #0d1117) padding-box, linear-gradient(135deg, #001f3f, #007bff) border-box;
                    padding: 20px 10px;
